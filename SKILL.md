...
| Situation | Action |
|-----------|--------|
| Session start | Kait auto-loads relevant cognitive context |
| Tool fails | Kait captures error pattern, suggests recovery |
...
Kait learns in these categories:
...
Kait automatically syncs learnings to workspace files:
...
When Mind is running (`python -m mind.lite_tier`), Kait syncs learnings for:
...
| `~/.kait/cognitive_insights.json` | Raw insight data |
...
- **Kait** — Self-evolving intelligence (this)
