# Kait Learning Guide: From Primitive Telemetry to Cognitive Intelligence

This document defines what makes learning valuable vs primitive, and how Kait should evolve from basic pattern detection to true cognitive intelligence.

---

## The Vision

Kait is not a personal assistant that learns one user's preferences. It is a **universal learning system** designed to achieve and exceed mastery across **all domains** through continuous learning. Every session with every user contributes to collective intelligence while respecting individual context.
...
**This is what Kait should primarily capture.**

---

## Project Onboarding Questions

When starting a new project, Kait should understand context to know what to track. Based on [Cognitive Task Analysis](https://journals.sagepub.com/doi/10.1177/10944281241271216) research:
...
Based on [research on self-improving agents](https://arxiv.org/abs/2506.05109), Kait needs intrinsic metacognition:
...
Unlike hardcoded domain chips, Kait should **discover and evolve domains organically**.

### Auto-Domain Detection

When Kait sees patterns it doesn't recognize:
...
During session, Kait observes and refines:
...
For Kait to achieve "beyond mastery" in any domain:
...
Kait tracks coverage across all domains and alerts when critical domains are neglected:
...
When building Lobster Royale, Kait should track:
