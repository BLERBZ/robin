...
def main() -> int:
    ...
    quality = [
        "When Kait is running, check /status (JSON readiness) because /health is only liveness.",
        ...
        "When you need strict enforcement, set KAIT_EIDOS_ENFORCE_BLOCK=1 and restart services.",
