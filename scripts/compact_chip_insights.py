...
def main() -> int:
    parser = argparse.ArgumentParser(description="Compact ~/.kait/chip_insights/*.jsonl")
    ...
    parser.add_argument("--archive", action="store_true", help="backup original files to ~/.kait/archive/chip_insights/<timestamp>")
    parser.add_argument("--apply", action="store_true", help="write changes (default is dry-run)")
    args = parser.parse_args()

    chip_dir = Path.home() / ".kait" / "chip_insights"
    ...
    if bool(args.archive):
        ...
        archive_dir = Path.home() / ".kait" / "archive" / "chip_insights" / stamp
