...
def _row_ts(row: Dict[str, Any]) -> float:
    # Different Kait logs use different timestamp keys.
...
def run_workload(
    ...
    *,
    ...
    engine_log = kait_dir / "advisory_engine.jsonl"
    feedback_requests = kait_dir / "advice_feedback_requests.jsonl"
    feedback_state = kait_dir / "advice_feedback_state.json"
