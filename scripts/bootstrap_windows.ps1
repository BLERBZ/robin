...
Write-Host "============================================="
Write-Host "  KAIT - Windows bootstrap"
Write-Host "============================================="
Write-Host ""
...
Write-Host "Installing Kait (services extras)..."
...
if ($SkipUp) {
  ...
  Write-Host ("Start later with: {0} -m kait.cli up" -f $venvPython)
  exit 0
}

Write-Host ""
Write-Host "Starting Kait services..."
Invoke-External -FilePath $venvPython -Arguments @("-m", "kait.cli", "up")
