...
DEFAULT_TUNEABLES = KAIT_DIR / "tuneables.json"
DEFAULT_ENGINE_FILE = KAIT_DIR / "advisory_engine.jsonl"
...
def _render_markdown(report: Dict[str, Any]) -> str:
    ...
    lines: List[str] = []
    lines.append("# Kait Advisory Day Trial Report")
    lines.append("")
...
def cmd_start(args: argparse.Namespace) -> int:
    ...
    state = {
        ...
        "env_snapshot": {
            "KAIT_ADVISORY_EMIT": os.environ.get("KAIT_ADVISORY_EMIT", ""),
        },
    }
...
def build_parser() -> argparse.ArgumentParser:
    ap = argparse.ArgumentParser(description="Run Kait advisory day trial (start/snapshot/close).")
