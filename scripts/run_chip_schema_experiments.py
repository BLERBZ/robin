...
def _run_experiment(
    *,
    ...
    env_overrides = {
        "KAIT_CHIP_REQUIRE_LEARNING_SCHEMA": str(runtime_cfg.get("require_learning_schema", "1")),
        "KAIT_CHIP_MIN_LEARNING_EVIDENCE": str(runtime_cfg.get("min_learning_evidence", 1)),
        "KAIT_CHIP_MIN_CONFIDENCE": str(runtime_cfg.get("min_confidence", 0.7)),
        "KAIT_CHIP_MIN_SCORE": str(runtime_cfg.get("min_score", 0.35)),
        "KAIT_CHIP_OBSERVER_ONLY": str(runtime_cfg.get("observer_only", "1")),
    }
