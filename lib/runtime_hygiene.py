...
PID_KEYS = ("kaitd", "bridge", "tailer", "pulse")
...
def cleanup_runtime_artifacts(
    *,
    ...
    kait_dir = Path(runtime_dir) if runtime_dir else Path.home() / ".kait"
    pid_file = Path(pid_state_file) if pid_state_file else (root / "scripts" / ".kait_pids.json")
