...
_KAIT_DIR = Path.home() / ".kait"
_DEFAULT_VAULT = str(Path.home() / "Documents" / "Obsidian Vault" / "Kait-Intelligence-Observatory")
...
def load_config() -> ObservatoryConfig:
    ...
    for p in [_KAIT_DIR / "tuneables.json",
