"""Kait Soul Upgrade integration helpers.

Lightweight bridge to consciousness state produced by Pulse/sidekick layer.
"""
...
def fetch_soul_state(session_id: str = "default", base_url: str = "http://127.0.0.1:8765") -> SoulState:
    ...
    url = f"{base_url.rstrip('/')}/api/sidekick/consciousness?{query}"
    try:
