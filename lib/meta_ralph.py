...
# Tuneables — defaults overridden by ~/.kait/tuneables.json → "meta_ralph" section.
QUALITY_THRESHOLD = 4
...
def _load_meta_ralph_config() -> None:
    """Load meta_ralph tuneables from ~/.kait/tuneables.json → "meta_ralph" section."""
...
class MetaRalph:
    """
    Meta-Ralph: Quality gate for Kait's self-evolution.
    ...
    # File paths
    DATA_DIR = Path.home() / ".kait" / "meta_ralph"
    ...
    def deep_analysis(self) -> Dict:
        """
        Comprehensive analysis of Kait's learning evolution.
    ...
    def print_deep_analysis(self) -> str:
        ...
        lines = [
            "",
            "=" * 70,
            " META-RALPH DEEP ANALYSIS: KAIT INTELLIGENCE EVOLUTION",
            "=" * 70,
            "",
        ]
