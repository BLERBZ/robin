"""
Adapter for opportunity_scanner — future migration path to kait-learning-systems.

Currently delegates to the local lib.opportunity_scanner module.
When opportunity_scanner moves to kait-learning-systems (system 27),
...
try:
    # Future: import from kait-learning-systems package
    # from kait_learning_systems.opportunity_scanner import (
    #     scan_runtime_opportunities,
    #     get_recent_self_opportunities,
    #     generate_user_opportunities,
    #     get_scanner_status,
    # )
    # from kait_learning_systems.opportunity_inbox import (
    #     load_self_opportunities,
    #     resolve_opportunity,
    #     record_decision,
    # )
    raise ImportError("kait_learning_systems not installed yet")
except ImportError:
