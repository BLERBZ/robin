...
ACTIVE_EPISODES_FILE = Path.home() / ".kait" / "eidos_active_episodes.json"
ACTIVE_STEPS_FILE = Path.home() / ".kait" / "eidos_active_steps.json"
PENDING_GOALS_FILE = Path.home() / ".kait" / "eidos_pending_goals.json"
