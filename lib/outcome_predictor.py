"""Outcome Predictor (world-model-lite) for Kait.
...
Flags
-----
- KAIT_OUTCOME_PREDICTOR=1 enables use by advisory gate.
...
PREDICTOR_ENABLED = os.getenv("KAIT_OUTCOME_PREDICTOR", "0") == "1"
STORE_PATH = Path.home() / ".kait" / "outcome_predictor.json"
