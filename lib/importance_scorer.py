...
This module addresses the core problem: Kait was deciding importance at PROMOTION time,
...
class ImportanceScorer:
    ...
    def _load_question_context(self):
        ...
        answers_file = Path.home() / ".kait" / "project_answers.json"
    ...
    def _init_semantic_intelligence(self):
        ...
        feedback_file = Path.home() / ".kait" / "importance_feedback.json"
