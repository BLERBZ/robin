"""
Advisory Emitter: The stdout bridge between Kait and Claude.
...
def format_advisory(
    ...
    - WARNING: [KAIT WARNING] prominent header
    - NOTE: [KAIT] clean inline note
