"""
Central schema and validator for Kait tuneables.
...
SCHEMA: Dict[str, Dict[str, TuneableSpec]] = {
    ...
    "advisory_packet_store": {
        ...
        "obsidian_export_dir": TuneableSpec("str", str(Path.home() / ".kait" / "advice_packets" / "obsidian"), None, None, "Override Obsidian export directory"),
    },
...
def generate_reference_doc() -> str:
    ...
    lines = [
        ...
        "## Overview",
        "",
        "All tuneables are stored in `~/.kait/tuneables.json` (runtime) and "
