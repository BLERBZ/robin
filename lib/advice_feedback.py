...
FEEDBACK_FILE = Path.home() / ".kait" / "advice_feedback.jsonl"
SUMMARY_FILE = Path.home() / ".kait" / "advice_feedback_summary.json"
STATE_FILE = Path.home() / ".kait" / "advice_feedback_state.json"
