...
def discover_openclaw_workspaces(*, include_nonexistent: bool = False) -> List[Path]:
    """Discover OpenClaw workspaces that may need Kait context/advisory files."""
    ...
    # Runtime convention: OpenClaw creates profile workspaces like workspace-kait-speed.
