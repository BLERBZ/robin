...
Phase 1 scope:
- Build an evidence bundle across available Kait memory sources
...
COGNITIVE_FILE = Path.home() / ".kait" / "cognitive_insights.json"
...
ORCHESTRATION_DIR = Path.home() / ".kait" / "orchestration"
_NOISE_PATTERNS = (
