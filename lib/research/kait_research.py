"""
Kait Research Integration

Provides commands for Kait/Claude to research domains
...
log = logging.getLogger("kait.research")
...
def get_mastery_summary(domain: str) -> str:
    ...
    Useful for showing what Kait knows about excellence in a domain.
    """
    researcher = get_researcher()
...
# Convenience functions for Kait hooks
