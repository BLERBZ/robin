...
AGREEMENT_GATE_ENABLED = os.getenv("KAIT_ADVISORY_AGREEMENT_GATE", "0") == "1"
try:
    AGREEMENT_MIN_SOURCES = max(
        1, min(5, int(os.getenv("KAIT_ADVISORY_AGREEMENT_MIN_SOURCES", "2") or 2))
    )
except Exception:
...
EMIT_WHISPERS = os.getenv("KAIT_ADVISORY_EMIT_WHISPERS", "1") == "1"
