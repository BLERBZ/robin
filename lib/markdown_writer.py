"""
Kait Markdown Writer: Human-readable learning output
...
Cognitive insights and patterns captured by Kait.
...
Failure patterns and recovery strategies captured by Kait.
...
"""
    ...
    def write_insight(self, insight: CognitiveInsight) -> str:
        ...
        print(f"[KAIT] Written to .learnings/LEARNINGS.md: {entry_id}")
        return entry_id
    ...
    def write_error(self, tool_name: str, error: str, context: Dict[str, Any] = None) -> str:
        ...
        entry_id = entry.split("]")[0].split("[")[1]
        print(f"[KAIT] Written to .learnings/ERRORS.md: {entry_id}")
        return entry_id
    ...
    def write_all_insights(self) -> Dict[str, int]:
        ...
        print(f"[KAIT] Markdown write complete: {stats}")
        return stats
