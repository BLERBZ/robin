...
Adapted from kait-forge (kait_forge/scorers/cli_opus.py, cli_codex.py,
reconciler.py, tendencies.py, parsing.py). Self-contained — no kait-forge import.
...
# ---------------------------------------------------------------------------
# JSON parsing (adapted from kait-forge parsing.py)
# ---------------------------------------------------------------------------
...
class DepthTendencyStore:
    ...
    DEFAULT_DB = Path.home() / ".kait" / "depth_tendencies.db"
