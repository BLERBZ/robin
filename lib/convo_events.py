"""
ConvoIQ Event Pipeline - Convert X conversation data into Kait events.
...
CONVO_EVENTS_FILE = Path.home() / ".kait" / "convo_events.jsonl"
...
def process_convo_through_chips(
    ...
    Main entry point for conversation intelligence -> Kait learning.
