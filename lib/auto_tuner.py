"""
Kait Auto-Tuner: Data-Driven Source Boost Optimization
...
TUNEABLES_PATH = KAIT_DIR / "tuneables.json"
EFFECTIVENESS_PATH = KAIT_DIR / "advisor" / "effectiveness.json"
COGNITIVE_INSIGHTS_PATH = KAIT_DIR / "cognitive_insights.json"
META_RALPH_PATH = KAIT_DIR / "meta_ralph.json"
EIDOS_DB_PATH = KAIT_DIR / "eidos.db"
TUNE_LOG_PATH = KAIT_DIR / "auto_tune_log.jsonl"
TUNEABLE_HISTORY_DIR = KAIT_DIR / "tuneable_history"
...
class AutoTuner:
    """Data-driven source boost optimizer for the Kait advisor."""
