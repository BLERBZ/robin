...
const PLUGIN_ID = "kait-telemetry-hooks";
const DEFAULT_SPOOL_FILE = process.env.KAIT_OPENCLAW_HOOK_EVENTS_FILE
  || path.join(os.homedir(), ".kait", "openclaw_hook_events.jsonl");
...
const plugin = {
  id: PLUGIN_ID,
  name: "Kait Telemetry Hooks",
  description: "Capture redacted llm_input/llm_output telemetry for Kait ingestion.",
