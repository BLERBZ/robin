#!/usr/bin/env python3
"""bridge_worker -- keep KAIT_CONTEXT.md fresh

This is the practical mechanism that makes Kait affect behavior in Clawdbot.
Clawdbot's kait-context hook injects KAIT_CONTEXT.md; this worker keeps it
