# Kait Advisory System — Complete Flowchart

## Main Pipeline (The [KAIT] Path)
...
║   │    ≥ 0.80  →  WARNING  [KAIT ADVISORY]                │               ║
║   │    ≥ 0.42  →  NOTE     [KAIT]          ◄── most common│               ║
║   │    ≥ 0.30  →  WHISPER  (kait: ...)                    │               ║
...
│  │ CLI: kait advisory prefs    │   │ Records suppressed items     │        │
...
│                                                                             │
│  Status: ENABLED (env KAIT_ADVISORY_PREFETCH_INLINE=1)                     │
...
│                                                                             │
│  ┌─────────────────────────┐        ┌──────────────────────────────┐        │
│  │ implicit_outcome_        │        │ ~/.kait/advisor/             │        │
...
│  │ Called from:             │        │ • CLI (kait advice-feedback) │        │
│  │ • observe.py (legacy)    │        │                              │        │
...
│  ┌──────────────────────────────────────────────────────────┐               │
│  │ stderr: "[KAIT] Outcome check-in: run `kait outcome`"  │               │
│  │ stderr: "[KAIT] Advice feedback pending..."             │               │
│  │                                                          │               │
...
│  │                              │   │                              │        │
│  │ Called by: bridge_cycle.py   │   │ Called by: kait/cli.py      │        │
...
│  └──────────────────────────────┘   └──────────────────────────────┘        │
│                                                                             │
│  NOT conflicting with [KAIT] advisory. Separate concern.                   │
└─────────────────────────────────────────────────────────────────────────────┘
```
