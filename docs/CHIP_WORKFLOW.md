...
```bash
# Install
kait chips install chips/my-chip.chip.yaml

# Activate
kait chips activate my-chip

# Verify
kait chips status my-chip
```
...
kait chips test my-chip --test-text "The campaign performed well with 3% CTR"
```
