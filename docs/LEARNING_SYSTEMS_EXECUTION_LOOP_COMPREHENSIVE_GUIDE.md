# Kait Learning Systems — Executive Loop Comprehensive Guide

## Scope and intent

This guide explains how to operate the Kait Learning Systems execution loop safely and intentionally:

- Discover what is broken or weak in Kait intelligence.
...
The control plane for this run loop is in **Kait Learning Systems**.
...
- `http://localhost:8787` — Kaitd / MCP daemon health endpoint
  - `/health`
- `http://localhost:8770` — Kait Neural/social intelligence layer
  - Docs: `/docs`
  - Status: `/api/status`
...
- `http://localhost:8765` — Kait Pulse / connected observability
  - Docs: `/docs`
  - Status: `/api/status`
...
## Best-practice execution order for “Kait intelligence and consciousness first”
...
1. **Assess consciousness and intention quality**
   ...
   - Review Kait consciousness-facing signals:  
...
### Kait tracer + advisory visibility (`:8765`)
...
- Action:
  ...
  - verify kait daemon bridge is online at `8787/health`
