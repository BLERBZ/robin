...
- Keep the packets folder at a stable location, e.g.
  - `<YOUR_OBSIDIAN_VAULT>/Kait-Intelligence-Observatory`
- In Obsidian, create a pinned note tab for:
  - `Kait\Watchtower\watchtower.md`
  - `Kait\Watchtower\packets\index.md`
- Optional: create a quick note `Kait Watchtower Log` and copy high-value packets there.
...
- No `index.md`: confirm Kait process loaded updated tuneables and restart.
