# Kait Change And Upgrade Workflow (Mandatory Optimizer Path)

Date: 2026-02-18
Applies to: `kait-intel` + integrations with `vibeship-kait-consciousness`

## Purpose

This is the standard workflow for making any Kait runtime change and proving whether it helped.
...
- Example surfaces: `kaitd.py`, `lib/consciousness_bridge.py`.
...
4. Tuneables (`~/.kait/tuneables.json`) (primary operating knobs)
