...
- copy the `hooks` object from `kait-hooks.json` into your settings, or
...
- Kait Pulse: http://127.0.0.1:${KAIT_PULSE_PORT:-8765}
- kaitd health: http://127.0.0.1:${KAITD_PORT:-8787}/health
...
Kait normalizes hook names to runtime event types used by chips:
