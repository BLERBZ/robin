...
This document defines how to cut a release candidate for Kait Intelligence and verify it is shippable.
...
- `vibeship_kait-0.1.0-py3-none-any.whl`
- `vibeship_kait-0.1.0.tar.gz`
...
2. Restart services:
   - `kait down`
   - `kait up --lite` (if the failure involves dashboards/pulse)
