# Kait Lightweight Operating Mode
...
Kait currently works end-to-end, but reliability trust is limited by noise and churn:
...
This policy keeps Kait lightweight and outcome-focused.
...
## Carmack Style Rules (Applied to Kait)
...
2. Update runtime/tuneables behavior:
   ...
   - `TUNEABLES.md`
   - `docs/KAIT_CARMACK_OPTIMIZATION_IMPLEMENTATION.md`
