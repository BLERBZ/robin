...
This workflow keeps Kait x OpenClaw changes organized and auditable in git.
...
- Run realtime benchmark (live canary + strict loop checks):
  - `python scripts/openclaw_realtime_e2e_benchmark.py --window-minutes 90 --run-canary --canary-agent kait-speed`
