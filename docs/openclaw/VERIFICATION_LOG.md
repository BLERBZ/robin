...
Purpose: keep an auditable history of end-to-end Kait x OpenClaw operational verification runs.
...
- Result summary:
  ...
  - PASS: hook events ingested to Kait queue.
...
- Command:
  - `python scripts/openclaw_realtime_e2e_benchmark.py --window-minutes 90 --run-canary --canary-agent kait-speed --canary-timeout-s 45 --settle-seconds 6`
- Report:
