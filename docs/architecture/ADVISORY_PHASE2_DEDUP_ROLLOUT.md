...
- `KAIT_PHASE2_OBSERVE_ONLY=1`
- `KAIT_PHASE2_LOG_DUAL_PATH_DIFF=1`
- `KAIT_PHASE2_DISABLE_LEGACY_OUTCOME=0`
- `KAIT_PHASE2_DISABLE_LEGACY_FALLBACK=0`
- `KAIT_PHASE2_DISABLE_LEGACY_ITEM_FEEDBACK=0`
...
- Set `KAIT_PHASE2_DISABLE_LEGACY_ITEM_FEEDBACK=1`.
...
- Set `KAIT_PHASE2_DISABLE_LEGACY_OUTCOME=1`.
...
- Set `KAIT_PHASE2_DISABLE_LEGACY_FALLBACK=1`.
