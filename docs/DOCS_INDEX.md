...
- `docs/KAIT_CHIPS_ARCHITECTURE.md`
...
- `docs/KAIT_EMOTIONS_V2.md` — Canonical emotion model
- `docs/KAIT_EMOTIONS_IMPLEMENTATION.md`
...
## Prompts
- `prompts/KAIT_INTELLIGENCE_PROMPT_LIBRARY.md` — 10 operator prompts
- `prompts/ADVISORY_DAILY_SELF_REVIEW_PROMPT.md`
- `prompts/CARMACK_KAIT_REVIEW_PROMPT.md`

## Learning guide
- `KAIT_LEARNING_GUIDE.md` — Primitive vs valuable learning, tiers, chips
- `docs/ONBOARDING.md`
