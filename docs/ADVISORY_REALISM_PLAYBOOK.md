...
Kait advisory quality can look good in narrow coding benchmarks while failing in real operations.
...
- `kait_pulse + advisory`
- `kait_porch + kait_depth + orchestration`
- `mind + semantic_memory + advisory`
- `kaitd + bridge_worker + openclaw_bridge`
...
This keeps Kait optimization tied to outcomes, not feature volume.
