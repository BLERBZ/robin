# Kait Intelligence Prompt Library (10)

These are paste-ready prompts intended for operating and improving Kait Intelligence. Each one is optimized for: evidence-first reasoning, minimal feature-addition, and fast iteration via tuneables/ablation.
...
**Prompt:**
You are my Kait operator. Run a stuck-state triage using `STUCK_STATE_PLAYBOOK.md` as the policy.
...
**Use when:** you suspect Kait "had the knowledge" but did not surface it, or retrieval is noisy.
...
**Use when:** you want Kait to actually improve week-over-week instead of accumulating noise.
