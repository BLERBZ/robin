...
**Purpose:** Central configuration for all pipeline stages. Supports hot-reload. Available in both runtime (~/.kait/tuneables.json) and version-controlled (config/tuneables.json) locations.
## Health
...
| Sections | 27 | healthy |
| Last modified | 20.4h ago | healthy |
## Sections
...
- `~/.kait/tuneables.json` — State storage
