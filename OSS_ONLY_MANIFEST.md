# OSS-only Manifest (Kait OSS launch)

Date: Saturday, February 21, 2026
Source: `kait-intel (repo root)`

## Launch objective

- Keep Kait OSS minimal and safe to publish.
...
- `.kait/`, `.pytest_cache/`, `__pycache__/`, and other runtime cache directories
- `sandbox/kait_sandbox/` tracked report/workspace metadata:
  - `sandbox/kait_sandbox/project/AGENTS.md`
  - `sandbox/kait_sandbox/project/CLAUDE.md`
  - `sandbox/kait_sandbox/project/PROJECT.md`
  - `sandbox/kait_sandbox/project/README.md`
  - `sandbox/kait_sandbox/project/SOUL.md`
  - `sandbox/kait_sandbox/project/TOOLS.md`
  - `sandbox/kait_sandbox/skills/sandbox-skill.yaml`
  - `sandbox/kait_sandbox/workspace/KAIT_CONTEXT.md`
