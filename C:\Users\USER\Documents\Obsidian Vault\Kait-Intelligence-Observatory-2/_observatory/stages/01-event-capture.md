...
| Scheduler | 49s ago | healthy |
| Watchdog | unknown | WARNING |
| Errors last cycle | 0 | healthy |
## Source Files

- `hooks/observe.py` — Core implementation
- `~/.kait/bridge_worker_heartbeat.json` — State storage
- `~/.kait/scheduler_heartbeat.json` — State storage
- `~/.kait/watchdog_state.json` — State storage
