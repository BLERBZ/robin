...
flowchart LR
  ...
  subgraph Bridge
    ...
    update_context["lib/bridge.update_kait_context"]
  end
  ...
  subgraph Learning
    ...
    chips_store["~/.kait/chip_insights/*.jsonl"]
  ...
  subgraph Semantic
    ...
    semantic_index["~/.kait/semantic/insights_vec.sqlite"]
    embeddings["lib/embeddings"]
    semantic_logs["~/.kait/logs/semantic_retrieval.jsonl"]
    advisor_metrics["~/.kait/advisor/metrics.json"]
  end
  ...
  bridge_cycle --> update_context --> kait_context
