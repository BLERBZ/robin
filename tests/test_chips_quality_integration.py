...
from lib.advisor import KaitAdvisor
...
def test_scoring_uniqueness_dedup_works():
    ...
    insight = {"chip_id": "kait-core", "content": "use read before edit for safe changes", "captured_data": {}}
...
def test_scoring_domain_relevance_covers_core_chips():
    ...
    kait_core = scorer.score(
        {"chip_id": "kait-core", "content": "debug fix pattern for tool workflow", "captured_data": {}}
    )
    bench = scorer.score(
    ...
    assert kait_core.domain_relevance >= 0.6
