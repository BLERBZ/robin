...
def _policy_with(advisor: advisor_mod.KaitAdvisor, **updates):
...
def test_chip_advice_blocks_telemetry_chips(monkeypatch, tmp_path):
    ...
    telemetry = {
        ...
        "content": "[Kait Core Intelligence] user_prompt_signal: event_type: post_tool",
        "confidence": 1.0,
    ...
    (tmp_path / "kait-core.jsonl").write_text(json.dumps(telemetry) + "\n", encoding="utf-8")
