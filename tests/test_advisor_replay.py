...
def _patch_runtime(monkeypatch, tmp_path: Path, records):
    ...
    monkeypatch.setattr(advisor_mod.KaitAdvisor, "_get_mind_advice", lambda _s, _c: [])
...
def test_replay_advisory_surfaces_better_alternative(monkeypatch, tmp_path):
    ...
    monkeypatch.setattr(advisor_mod.KaitAdvisor, "_get_cognitive_advice", lambda _s, _t, _c, _sc=None: [baseline])
