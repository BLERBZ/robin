"""
Tests for lib/advisor.py — KaitAdvisor core module.
...
from lib.advisor import Advice, AdviceOutcome, KaitAdvisor
...
def _build_advisor(monkeypatch, tmp_path) -> KaitAdvisor:
...
class TestPublicHelpers:
    ...
    def test_generate_context_block_empty_when_no_advice(self, monkeypatch, tmp_path):
        _patch_advisor(monkeypatch, tmp_path)
        monkeypatch.setattr(KaitAdvisor, "advise", lambda *_a, **_kw: [])
        adv = KaitAdvisor()
