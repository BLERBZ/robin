...
SCENARIOS: List[Scenario] = [
    ...
    Scenario(
        ...
        tool_name="Edit",
        tool_input={"file_path": "~/.kait/tuneables.json", "old_string": '"threshold": 4', "new_string": '"threshold": 5'},
    ...
    Scenario(
        ...
        tool_name="Bash",
        tool_input={"command": "python lib/service_control.py start kait_pulse"},
    ...
    Scenario(
        ...
        tool_name="Read",
        tool_input={"file_path": "~/.kait/tuneables.json"},
