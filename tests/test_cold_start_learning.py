...
Tests whether explicit learning signals in code are captured by Kait.
...
BASELINE_FILE = Path.home() / '.kait' / 'iteration_baseline.json'
...
def test_explicit_signals():
    ...
    # These are the explicit signals we want Kait to capture
