...
def _patch_non_mind_sources(monkeypatch, bank_items):
    monkeypatch.setattr(advisor_mod.KaitAdvisor, "_get_bank_advice", lambda _s, _c: list(bank_items))
    ...
    monkeypatch.setattr(advisor_mod.KaitAdvisor, "_get_opportunity_advice", lambda _s, **_k: [])
...
def test_stale_mind_skipped_when_other_sources_exist(monkeypatch, tmp_path):
    ...
    monkeypatch.setattr(advisor_mod.KaitAdvisor, "_get_mind_advice", _mind)
