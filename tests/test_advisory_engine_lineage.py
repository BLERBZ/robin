...
def test_global_recently_emitted_respects_scope_key(monkeypatch, tmp_path):
    ...
    engine._append_jsonl_capped(
        ...
        {"ts": now - 5, "tool": "Edit", "advice_id": "a1", "scope_key": "agent:kait-ship"},
        max_lines=50,
    )
