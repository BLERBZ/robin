...
Tests that verify the Kait Intelligence pipeline is operational according to
...
Architecture (from Intelligence_Flow.md):
    Sources (observe.py, kaitd.py)
        -> Queue (~/.kait/queue/events.jsonl)
...
class PipelineHealthChecker:
    """
    Verifies Kait Intelligence pipeline health according to Intelligence_Flow.md.
    ...
    def check_queue_recent_events(self) -> Tuple[bool, int]:
        ...
        try:
            ...
            # KaitEvent has .timestamp as a float (unix timestamp)
            recent_count = 0
            one_hour_ago = datetime.now().timestamp() - 3600
            for event in events:
                # KaitEvent is a dataclass with timestamp attribute
    ...
    def check_bridge_worker_heartbeat(self) -> Tuple[bool, int]:
        ...
        """
        heartbeat_file = KAIT_DIR / 'bridge_worker_heartbeat.json'
    ...
    def check_cognitive_learner_storage(self) -> Tuple[bool, int]:
        ...
        insights_file = KAIT_DIR / 'cognitive_insights.json'
        ...
        try:
            ...
            if claude_md.exists():
                try:
                    ...
                    has_learnings = 'KAIT_LEARNINGS_START' in content
                    self._add_check(
                        "Promoter activity",
                        has_learnings,
    ...
    def check_mind_connection(self) -> Tuple[bool, Dict]:
        ...
        try:
            import requests
            port = os.environ.get("KAIT_MIND_PORT", "8080")
    ...
    def run_full_check(self) -> Dict:
        ...
        print("\n" + "=" * 70)
        print(" KAIT INTELLIGENCE PIPELINE HEALTH CHECK")
