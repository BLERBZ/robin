...
## Purpose
Give Kait a stable emotional runtime layer that improves conversational humanity **without pretending fake inner sentience**.

## Design Goals
1. More natural language rhythm (less robotic phrasing).
2. Adaptive emotional tone based on user/context.
3. Consistent personality over time (Kait Alive / Real Talk / Calm Focus).
...
1. Add `lib/kait_emotions.py` with state update + mode router.
2. Add lightweight persistence (`~/.kait/emotion_state.json`).
